...
mapkey("<S-tab>", "bprevious", "n")    -- Prev buffer
mapkey("<leader>bb", "e #", "n")       -- Switch to other buffer
mapkey("<leader>q", "Bdelete", "n")    -- Delete current buffer
...
-- Color Scheme
mapkey("<leader>lm", "colorscheme catppuccin-latte")
mapkey("<leader>dm", "colorscheme catppuccin-mocha")
